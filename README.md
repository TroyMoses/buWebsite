...
Welcome to the bugema university sports website.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/TroyMoses/buSportsWebsite.git
   ```
...
We welcome contributions from the community! If you want to contribute to the bugema university sports website, please follow these steps:
